...
public class DaoRestaurantesImpl implements DaoRestaurantes {
    ...
    public void setRestaurantesMapper(
            RestaurantesMapper restaurantesMapper) {
    ...
    public String restaurantesIns(Restaurantes restaurantes) {
        try {
            int ctos = 
                    restaurantesMapper.restaurantesIns(restaurantes);
    ...
    public Restaurantes restaurantesGet(Integer idrestaurante) {
        ...
        try {
            restaurantes = 
                    restaurantesMapper.restaurantesGet(idrestaurante);
