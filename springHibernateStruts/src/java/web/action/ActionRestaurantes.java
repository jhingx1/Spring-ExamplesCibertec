...
public class ActionRestaurantes
    ...
    public String restaurantesDel() {
        ...
        String result = daoRestaurantes.restaurantesDel(list);
    ...
    public String restaurantesUpd() {
        ...
        Categorias c = daoCategorias.categoriasGet(
                restaurantes.getCategorias().getIdcategoria());
        Distritos d = daoDistritos.distritosGet(
                restaurantes.getDistritos().getIddistrito());
    ...
    public void validate() {
        if (restaurantes != null) {
            ...
            if ((restaurantes.getCategorias().getIdcategoria() == null)) {
                addFieldError("restaurantes.categorias.idcategoria",
            ...
            if ((restaurantes.getDireccion()== null)
                ...
                addFieldError("restaurantes.direccion",
                        "Ingrese Direccion de Restaurante");
            }

            if ((restaurantes.getDistritos().getIddistrito() == null)) {
                addFieldError("restaurantes.distritos.iddistrito",
                        "Seleccione Distrito");
            }
        }
    }
